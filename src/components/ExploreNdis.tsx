  ...
  return (
    <section className="py-10 px-4 bg-light-grey">
      <div className="border-2 border-main-pink md:w-3/4 mx-auto hover:bg-white rounded-xl p-4">
        ...
        />
        <p className="font-bold lg:text-2xl text-center text-gray-500">
        ...
        <Button className="flex items-center gap-3 border-2 border-main-purple rounded-full text-main-purple px-4 py-2 mt-8 cursor-pointer mx-auto hover:scale-125 transition duration-700 ease-linear">
